...
/**
 *  ChessDb - a database of chess games
 * @author adussa3
 * @version 1.0
 */
public class ChessDb {
    ...
    /**
     * [ChessDb - a constructor that describes the games in the chess database]]
     */
    public ChessDb() {
        games = new ArrayList<>();
    ...
    /**
     * [getGames - gets the games of the chess database]
     * @return [a List of ChessGames in the chess database]
     */
